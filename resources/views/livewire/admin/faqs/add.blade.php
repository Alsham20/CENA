    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Ajouter un faq</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="store">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <input type="checkbox" wire:model="is_active" id="switch1" checked data-switch="bool" />
...
<script>
    document.addEventListener('livewire:initialized', function() {
        ...
        snowEditor.on('text-change', () => {
            @this.set('answer', snowEditor.root.innerHTML, false);
        });
        ...
        /*Livewire.on('updatePoster', function(url) {
            // Insérer l'image à la position actuelle du curseur dans l'éditeur Quill
            const range = snowEditor.getSelection();
            if (range) {
                snowEditor.insertEmbed(range.index, 'image', url);
            }
