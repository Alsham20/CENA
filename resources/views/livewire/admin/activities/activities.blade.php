    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Activités</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-5">
                            <a href="{{route('activities.create')}}" class="btn btn-success mb-2"><i
                                    class="mdi mdi-plus-circle me-2"></i> Ajouter une activité</a>
                        </div>
                        @endcan
                        <!-- end col-->
                    </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-action">
                                        @can('view activities')
                                        <a href="{{route('activities.show', $activity->id)}}"> <i
                                                class="mdi mdi-eye text-info h3"></i></a>
                                        @endcan

                                        @can('edit activities')
                                        <a href="{{route('activities.edit', $activity->id)}}"> <i
                                                class="mdi mdi-square-edit-outline text-primary h3"></i></a>
                                        @endcan

                                        @can('delete activities')
                                        <a href="javascript:void(0);"
                                            wire:click.prevent="$dispatch('confirm-delete',{{$activity->id}})"> <i
                    ...
                    <div class="row mt-3">
                        <div class="col-sm-12 col-md-5">
                            <div class="dataTables_info" id="products-datatable_info" role="status" aria-live="polite">
                                Afficher {{$activities->firstItem()}} a {{$activities->lastItem()}}
                                sur {{$activities->total()}}</div>
                        </div>
                            ...
                            <div class="dataTables_paginate paging_simple_numbers float-end"
                                ...
                                <nav aria-label="Page navigation example">
                                    <ul class="pagination justify-content-end">
                                        <!-- Bouton Précédent -->
                                        <li class="page-item @if($activities->onFirstPage()) disabled @endif">
                                        ...
                                        <li class="page-item @if($activities->currentPage() == $page) active @endif">
                                        ...
                                        <!-- Bouton Suivant -->
                                        <li class="page-item @if(!$activities->hasMorePages()) disabled @endif">
            ...
            <div class="modal-content modal-filled bg-danger">
                <div class="modal-body p-4">
                    <div class="text-center">
                        ...
                        <p class="mt-3">Voulez-vous supprimer cette activité? Cette action est irreversible</p>
                        ...
                        <button type="button" class="btn btn-warning my-2"
                            wire:click="deleteActivity({{$confirm_delete}})">Confirmer
                        </button>
                        @endif
                    </div>
                </div>
    ...
    Livewire.on('confirm-delete', id => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Livewire.dispatch('deleteActivity', {
                    activity_id: id
                });
                /*Swal.fire(
                    'Supprimé!',
