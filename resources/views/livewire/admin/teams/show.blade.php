    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Afficher un membre</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form>
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="lastname" type="text" id="simpleinput" class="form-control">
                                @error('lastname')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="firstname" type="text" id="simpleinput" class="form-control">
                                @error('firstname')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="fonction" type="text" id="simpleinput" class="form-control">
                                @error('fonction')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="facebook_link" type="text" id="facebook_link" class="form-control">
                                @error('facebook_link')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="tweeter_link" type="text" id="tweeter_link" class="form-control">
                                @error('tweeter_link')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input disabled wire:model="linkedin_link" type="text" id="linkedin_link" class="form-control">
                                @error('linkedin_link')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3 mb-3">
                                <div class="form-check">
                                    <input disabled id="is_private" wire:model.live="is_private" value="1" type="checkbox" class="form-check-input" id="checkbox-signin">
                            ...
                            <div class="mb-3" wire:ignore>
                                ...
                                <div class="card mb-0 h-100 avatar_card d-none">
                                    <div class="card-body">
                                        <div class="border-dashed border-2 border rounded col-3 p-1">
