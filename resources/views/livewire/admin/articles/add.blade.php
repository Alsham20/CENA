                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="store">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-3">
                                <div class="form-check">
                                    <input id="is_private" wire:model.live="is_private" value="1" type="checkbox" class="form-check-input" id="checkbox-signin">
                            ...
                            <div class="mb-3" wire:ignore>
                                ...
                                @enderror
                                <div id="resume" class="mb-3" style="height: 200px;">
                                ...
                                <div class="mb-3" wire:ignore>
                                    ...
                                    @enderror
                                    <div id="snow-editor" class="mb-3" style="height: 400px;">
...
<script>
    document.addEventListener('livewire:initialized', function () {
        ...
        var keytag = new Tagify(keywords, {
            whitelist: [],
            maxTags: 10,
            dropdown: {
                maxItems: 20,           // <- mixumum allowed rendered suggestions
