    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Modifier un résultat</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                ...
                <div class="card-body">
                    ...
                    <form wire:submit.prevent="store">
                        <div class="col-lg-12 mb-3" wire:ignore>
                            ...
                            <select wire:model="election_id" class="form-control election_id">
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="zone" type="text" id="zone" class="form-control">
                            @error('zone')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="date_resultat" type="date" id="date_resultat" class="form-control">
                            @error('date_resultat')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input wire:model="url" type="text" id="simpleinput" class="form-control">
                            @error('url')
                            <div class="alert alert-danger" role="alert">
                                {{ $message }}
                            </div>
