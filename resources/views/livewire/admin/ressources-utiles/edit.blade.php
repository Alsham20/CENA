    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Modifier une ressource</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form wire:submit.prevent="update" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-lg-12 mb-3">
                                ...
                                <select wire:model="categorie_id" class="form-control parent" >
                            ...
                            <div class="mb-3" wire:ignore>
                                <p class="mb-1 fw-bold text-muted">Date de publication</p>
                                <input value="{{ \Carbon\Carbon::parse($date_creation)->format('d/m/Y') }}" placeholder="jj/mm/aaaa" type="text" id="datepicker" class="form-control">
    ...
    document.addEventListener('livewire:initialized', function () {
        ...
        var datepicker = new Datepicker('#datepicker',{
            ...
            onChange: function(date) {
                ...
                @this.set('date_creation', dateFormatted, false)
            },
