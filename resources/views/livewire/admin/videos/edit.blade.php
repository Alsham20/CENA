    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">Modifier une vidéo</h4>
            </div>
        </div>
    </div>
    <!-- end page title -->
                    ...
                    <form wire:submit.prevent="update">
                        <div class="row">
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="video_path" type="text" id="simpleinput" class="form-control">
                                @error('video_path')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input wire:model="date_video" type="date" id="date_video" class="form-control">
                                @error('date_video')
                                <div class="alert alert-danger" role="alert">
                                    {{ $message }}
                                </div>
